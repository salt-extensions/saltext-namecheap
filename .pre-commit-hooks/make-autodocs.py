...
src_dir = repo_path / "src" / " saltext" / "saltext-namecheap"
...
for path in Path(__file__).parent.parent.joinpath("src/saltext/saltext-namecheap/").glob("*/*.py"):
...
"""
    ...
    all_rst.write_text(
        f"""
.. all-saltext.saltext-namecheap.{kind}:
