...
The saltext-namecheap project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-namecheap.git
...
* Writing blog posts
* Sharing your experiences using Salt + Namecheap
  on social media
